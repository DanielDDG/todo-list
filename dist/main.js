...
class CreateTaskUI {
    ...
    createTaskUI(task) {
        ...
        _elements__WEBPACK_IMPORTED_MODULE_0__.retrievedElements.mainTaskContainer.appendChild(this.UITaskContainer);
...
class FilterTasks {
    ...
    filterTasks() {
        ...
        _elements__WEBPACK_IMPORTED_MODULE_0__.retrievedElements.todayLabel.addEventListener('click', () => {
            let taskArray = document.querySelectorAll('.UITaskContainer');
